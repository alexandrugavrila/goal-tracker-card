...
const DEFAULT_STORAGE_ENTITY = "input_text.goal_tracker_data";
...
function applyConfigSeeds(envelope, configGoals = []) {
...
function serializeStorage(goals, seededConfigKeys = []) {
