      ...
      <div class="practice-row">
        ...
        <div class="timeline-context" aria-live="polite">
          ...
          <span class="timeline-expanded">
            ${expandedPath
              ? html`Expanded: ${expandedPath} → ${expandedUnit}`
              : "All days shown"}
          </span>
        </div>
        <div
        ...
        >
          ...
          >
            ...
            ${expansionGroups.map((group) => html`
              <div
        ...
        <div class="modal-content" @click=${(event) => event.stopPropagation()}>
          ...
          ${practice.mode === "number"
            ? html`
                ...
                >
                  ${PRACTICE_COMPARISONS.map((comparison) => html`
